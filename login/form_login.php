        ...
        <header class="d-flex position-relative">
            ...
            <nav class="bg-secondary navbar navbar-expand-md fixed-top">
                ...
                <div class="container-fluid">
                    ...
                    <button type="submit" class="btn btn-outline-light my-1 my-sm-0" onclick="location.href='../index.php'" data-toggle="modal" data-target="#myModal">Pagina inicial</button>
                        ...
                        <div class="shadow flex-column border rounded">
                            ...
                            <form class="needs-validation" action="login.php" method="POST" >
                                ...
                                <div class="bg-secondary px-4 py-3 border rounded">
                                    ...
                                    <label class="text-center text-white h3 mb-0 ">Insira os dados para logar</label>
                                ...
                                <div class="input-group px-4 mt-4 mb-2">
                                    ...
                                    <input type="text" class="form-control text-center p-0 font-weight-bold bg-white" name="login" id="link">
                                ...
                                <div class="input-group px-4 mt-3 ">
                                    ...
                                    <input type="password" class="form-control text-center p-0 font-weight-bold bg-white" name="password" id="nome">
                                ...
                                <div class="input-group justify-content-center align-items-center px-4 my-4 ">
                                    ...
                                    <button 
                                        type="submit" 
                                        class="btn btn-secondary text-white text-center rounded" 
                                        data-toggle="modal" 
